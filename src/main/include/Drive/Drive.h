...
private:
    ...
    wpi::array<frc::Translation2d, 4> locations {
        frc::Translation2d(-DrivePreferences::ROBOT_WIDTH/2, +DrivePreferences::ROBOT_LENGTH/2), // Front left.
        frc::Translation2d(+DrivePreferences::ROBOT_WIDTH/2, +DrivePreferences::ROBOT_LENGTH/2), // Front right.
        frc::Translation2d(-DrivePreferences::ROBOT_WIDTH/2, -DrivePreferences::ROBOT_LENGTH/2), // Back left.
        frc::Translation2d(+DrivePreferences::ROBOT_WIDTH/2, -DrivePreferences::ROBOT_LENGTH/2), // Back right.
    };
    /**
    ...
    frc::ProfiledPIDController<units::radians> trajectoryThetaPIDController {
        DrivePreferences::PID_THETA.Kp, DrivePreferences::PID_THETA.Ki, DrivePreferences::PID_THETA.Ki,
